...
export EMAIL_SETTINGS__SEND_EMAIL_NOTIFICATIONS=${EMAIL_SETTINGS__SEND_EMAIL_NOTIFICATIONS:=""}
export EMAIL_SETTINGS__REQUIRE_EMAIL_VERIFICATION=${EMAIL_SETTINGS__REQUIRE_EMAIL_VERIFICATION:=""}
...
export EMAIL_SETTINGS__SEND_PUSH_NOTIFICATIONS=${EMAIL_SETTINGS__SEND_PUSH_NOTIFICATIONS:=""}
export EMAIL_SETTINGS__PUSH_NOTIFICATION_SERVER=${EMAIL_SETTINGS__PUSH_NOTIFICATION_SERVER:=""}
export EMAIL_SETTINGS__PUSH_NOTIFICATION_CONTENTS=${EMAIL_SETTINGS__PUSH_NOTIFICATION_CONTENTS:=""}
